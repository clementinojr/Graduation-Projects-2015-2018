...
public class JMainFrame extends JFrame {
	...
	public JMainFrame() {
		...
		Conf.feature_color_R = true;
		Conf.feature_color_G = true;
		Conf.feature_color_B = true;
		Conf.feature_color_Y = false;
		Conf.feature_color_Cr = false;
		Conf.feature_color_Cb = false;
		Conf.feature_color_H = false;
		Conf.feature_color_S = false;
		Conf.feature_color_V = false;
